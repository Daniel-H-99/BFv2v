...
source_dir="/home/server25/minyeong_workspace/Experiment/qualitative/TPSMM/202205191633"
source_images="
W_00003
"
...
ffmpeg -y -i "/home/server25/minyeong_workspace/Experiment/data/demo/speech/00001.mp4" \
 -i ${source_dir}/mute_00001_00001.mp4  \
 -i ${source_dir}/mute_00002_00001.mp4  \
 -i ${source_dir}/mute_00003_00001.mp4  \
 -i ${source_dir}/mute_00004_00001.mp4  \
 -i ${source_dir}/mute_00005_00001.mp4  \
 -filter_complex \
    "[0:v]scale=-1:256[v1]; \
    ...
    [v1][v2][v3][v4][v5][v6]hstack=inputs=6[v]" -map "[v]" ${source_dir}/demo.mp4
