...
checkpoint="/home/server25/minyeong_workspace/BFv2v/log/rotation_ckpt/00003099-checkpoint.pth.tar"
checkpoint_headmodel=log_headmodel/v2.1/best.tar
...
do 
    ...
    do  
        ...
        python demo.py --config config/vox-256-renderer.yaml --checkpoint "${checkpoint}" --source_image $source_image --checkpoint_headmodel $checkpoint_headmodel --result_vid $vid --driven_dir log_headmodel/v2.1
        conda deactivate
