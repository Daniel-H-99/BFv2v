...
class Logger:
    ...
    @staticmethod
    def load_cpk(checkpoint_path, generator=None, discriminator=None, seq_discriminator=None, kp_detector=None,
        ...
        if seq_discriminator is not None:
            try:
               discriminator.load_state_dict(checkpoint['seq_discriminator'])
            except:
               print ('No discriminator in the state-dict. Dicriminator will be randomly initialized')
        ...
        if optimizer_seq_discriminator is not None:
            try:
                optimizer_seq_discriminator.load_state_dict(checkpoint['optimizer_seq_discriminator'])
            except RuntimeError as e:
                print ('No seq discriminator optimizer in the state-dict. Optimizer will be not initialized')
